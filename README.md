...
该教程围绕一个**企业级 AI 电子伴侣产品**展开，从智能体认知、LangChain/LangGraph 编排、Monorepo 工程化到 Hono.js 边缘部署，共 100 章，持续更新中。
...
| [roadmap.md](roadmap.md) | 6 阶段学习路径、每阶段 Milestone 检查点、难度等级、常见卡点提醒 |
| [知识地图.md](知识地图.md) | 6 大领域知识结构树、100 章节映射、依赖关系、跨章节关联、最小学习路径 |
...
| 🟠 | LCEL 链式调用 | Ch31-34 |
| 🟠 | Hono RPC 端到端类型安全 | Ch89, 100 |
| 🟠 | 边缘存储三件套 D1+KV+Vectorize | Ch85-87, 95 |
| 🟠 | 流式响应 SSE | Ch15, 50, 90 |
...
Phase 1 理论认知 (Ch01-20)
  → Phase 2 LangChain (Ch21-43)
    → Phase 3 LangGraph (Ch44-61)  ← 最难阶段
      ...
      → Phase 5 Hono.js (Ch76-100) ←┘ 可并行
        → Phase 6 综合实战
```

> 最小路径：24 章覆盖所有核心知识点，详见 [知识地图.md](知识地图.md) 第七节。
